...
values (
  ...
  $jsonb${"romMobility":["Initiate ankle PROM/AAROM/AROM — DO NOT dorsiflex past 0° (neutral)","Ankle pumps (no DF beyond neutral)","Ankle circles (no DF beyond neutral)","Ankle inversion","Ankle eversion","Seated heel-slides for DF ROM (not past 0°)","If stiff: great toe DF/PF stretching (do not exceed neutral DF at ankle)","Foot/ankle joint mobilizations per therapist discretion (avoid pressure on healing incision)","Gentle scar mobilization once incision healed — NO IASTM directly on tendon until at least 16 weeks post-op"],"strengthening":["Once able to sit with foot flat and ankle near neutral DF: seated heel raises, seated arch doming, foot intrinsic muscle exercises"],"proprioception":["Joint position re-training"]}$jsonb$::jsonb,
  $jsonb${"cardio":["Upper body ergometer"],"strengthening":["Continue proximal lower-extremity strengthening (Phase I)","Lumbopelvic: planks (in Achilles boot)"]}$jsonb$::jsonb,
  $jsonb$["Normalize gait in boot using a Shoe Leveler on the uninvolved side","Optimal gait in Achilles boot with 1 wedge, crutches, and Shoe Leveler"]$jsonb$::jsonb,
...
values (
  ...
  $jsonb${"romMobility":["Continue seated heel-slides for DF (DF no longer restricted — progress gently)","Continue toe stretching as needed","Ankle/foot mobilizations (talocrural, subtalar, midfoot, MTPs)","No overt calf stretching NWB or WB; calf towel stretch only if DF ROM progression is delayed"],"strengthening":["4-way ankle with resistance band"]}$jsonb$::jsonb,
  $jsonb${"romMobility":["Gentle stretching of proximal muscle groups (standing quad, standing hamstring, kneeling hip flexor, piriformis)"],"cardio":["Stationary bicycle (in Achilles boot)"],"strengthening":["Lumbopelvic: bridges on physioball, bridge with roll-in, alternating","Gym: hip abductor/adductor machine, hip extension machine, roman chair — progress intensity and duration"]}$jsonb$::jsonb,
  $jsonb$["Normalize gait in Achilles boot without wedges using a Shoe Leveler","FWB in boot without wedges, without crutches, normalized gait by week 8","Normal gait in boot without wedges or crutches"]$jsonb$::jsonb,
...
values (
  ...
  $jsonb${"romMobility":["Ankle/foot mobilizations as indicated","Continue seated heel-slides for DF; progress to standing ankle dorsiflexion stretch on a step"],"strengthening":["Begin standing calf raise progression: bilateral 25% BW through involved → 50% equal → 75% BW through involved"],"balanceProprioception":["Double-limb balance on uneven surface (wobble board)","Single-limb balance → uneven surface including perturbation training"]}$jsonb$::jsonb,
  $jsonb${"cardio":["Stationary bike","Flutter-kick swimming / pool jogging (only if incision fully healed)"],"strengthening":["Gym: seated hamstring curl machine, leg press machine"]}$jsonb$::jsonb,
  $jsonb$["Normalize gait in supportive sneaker with 1 cm heel lift"]$jsonb$::jsonb,
...
values (
  ...
  $jsonb${}$jsonb$::jsonb,
  $jsonb${"note":["Continue to progress ROM, cardio, strengthening, balance, and proprioception from previous phases as indicated"]}$jsonb$::jsonb,
  $jsonb$["Normalize gait in supportive sneakers without heel lift","Wean heel-lift from sneaker; normalize gait pattern"]$jsonb$::jsonb,
...
values (
  ...
  $jsonb${"romMobility":["Continue standing ankle DF mobilization on step","May initiate gentle IASTM directly to the tendon beginning at 16 weeks"],"strengthening":["If able to perform bilateral standing heel raises with 75% BW through full range of involved limb → progress to eccentric calf raises (bilateral raise, unilateral lowering on involved) on level surface → unilateral heel raises","Seated calf machine or wall sit with bilateral calf raises"],"plyometrics":["Beginner level. After 3×15 bilateral standing heel raises (equal WB) → rebounding heel raises bilateral stance","After 3×15 unilateral heel raises → rebounding unilateral heel raises","With good tolerance → hopping in place bilateral → progress to unilateral"]}$jsonb$::jsonb,
  $jsonb${"cardio":["Elliptical","Stair climber"],"strengthening":["Proximal control: hip hike; forward lunges (lead with injured leg first, then uninjured); lateral lunges; bilateral squat → single-leg progression (partial-WB single-leg press, slide-board lunges retro/lateral, step-ups, step-ups with march, lateral step-ups, step-downs, single-leg squats, single-leg wall slides)"]}$jsonb$::jsonb,
  $jsonb$null$jsonb$::jsonb,
...
values (
  ...
  $jsonb$null$jsonb$::jsonb,
  $jsonb${"id":"willits-accelerated","name":"Willits — Achilles Tendon Rupture Accelerated Functional Rehabilitation Protocol","source":"Willits et al., eAppendix Table E-1","appliesTo":["surgical","non_surgical"],"gating":"time","globalNotes":["Same timeline applies to both groups; the 0–2 week entry differs: surgical group starts immediately post-op, non-operative group starts after injury.","Boot worn while sleeping. May remove boot for bathing/dressing but must adhere to weight-bearing restrictions."],"redFlags":{"source":"achilla-baseline","action":"Advise the user to contact their referring physician / care team.","signs":["Fever","Uncontrolled pain","Excessive drainage from the incision","Unresolving numbness or tingling","Calf swelling, warmth, or redness (possible DVT)","A sudden \"pop\" or new gap/weakness (possible re-rupture)","Any other symptom of concern"],"note":"The Willits source table (a research-paper timeline, not a clinical handout) does not include red-flag guidance. This list is Achilla's general post-op safety baseline, not part of the Willits protocol itself."},"phases":[{"orderIndex":0,"number":null,"name":null,"timeframeLabel":"0–2 weeks","timeframeStartDays":0,"timeframeEndDays":14,"weightBearing":"Posterior slab/splint; non-weight-bearing with crutches (immediately post-op for surgical group; after injury for non-operative group).","assistiveDevices":["posterior slab/splint","crutches"],"interventions":{},"achillesInterventions":{},"restOfBodyInterventions":{},"gaitTraining":null},{"orderIndex":1,"number":null,"name":null,"timeframeLabel":"2–4 weeks","timeframeStartDays":14,"timeframeEndDays":28,"weightBearing":"Aircast walking boot with 2-cm heel lift. Protected weight-bearing with crutches.","assistiveDevices":["Aircast walking boot","2 cm heel lift","crutches"],"interventions":{"romMobility":["Active plantar flexion and dorsiflexion to neutral","Inversion/eversion below neutral"],"modalities":["Modalities to control swelling","Incision mobilization modalities"],"strengthening":["Knee/hip exercises with no ankle involvement (leg lifts from sitting, prone, or side-lying)"],"cardio":["Non-weight-bearing fitness/cardio: one-leg bicycling, deep-water running"],"other":["Hydrotherapy within motion and weight-bearing limits"]},"achillesInterventions":{"romMobility":["Active plantar flexion and dorsiflexion to neutral","Inversion/eversion below neutral"],"modalities":["Modalities to control swelling","Incision mobilization modalities"]},"restOfBodyInterventions":{"strengthening":["Knee/hip exercises with no ankle involvement (leg lifts from sitting, prone, or side-lying)"],"cardio":["Non-weight-bearing fitness/cardio: one-leg bicycling, deep-water running"],"other":["Hydrotherapy within motion and weight-bearing limits"]},"gaitTraining":null},{"orderIndex":2,"number":null,"name":null,"timeframeLabel":"4–6 weeks","timeframeStartDays":28,"timeframeEndDays":42,"weightBearing":"Weight-bearing as tolerated (WBAT).","assistiveDevices":[],"continuesFromOrderIndexes":[1],"interventions":{"note":["Continue the 2–4 week protocol"]},"achillesInterventions":{},"restOfBodyInterventions":{"note":["Continue the 2–4 week protocol"]},"gaitTraining":null},{"orderIndex":3,"number":null,"name":null,"timeframeLabel":"6–8 weeks","timeframeStartDays":42,"timeframeEndDays":56,"weightBearing":"Remove heel lift. Weight-bearing as tolerated.","assistiveDevices":[],"interventions":{"romMobility":["Dorsiflexion stretching, slowly"],"strengthening":["Graduated resistance exercises (open and closed kinetic chain, plus functional activities)"],"proprioception":["Proprioceptive and gait retraining"],"modalities":["Ice, heat, ultrasound as indicated","Incision mobilization"],"cardio":["Fitness/cardio including WBAT: bicycling, elliptical, treadmill walking/running, StairMaster"],"other":["Hydrotherapy"]},"achillesInterventions":{"romMobility":["Dorsiflexion stretching, slowly"],"modalities":["Ice, heat, ultrasound as indicated","Incision mobilization"]},"restOfBodyInterventions":{"strengthening":["Graduated resistance exercises (open and closed kinetic chain, plus functional activities)"],"cardio":["Fitness/cardio including WBAT: bicycling, elliptical, treadmill walking/running, StairMaster"],"other":["Hydrotherapy"]},"gaitTraining":["Proprioceptive and gait retraining"]},{"orderIndex":4,"number":null,"name":null,"timeframeLabel":"8–12 weeks","timeframeStartDays":56,"timeframeEndDays":84,"weightBearing":"Wean off boot. Return to crutches and/or cane as necessary, then gradually wean off.","assistiveDevices":["crutches (weaning)","cane (weaning, as necessary)"],"continuesFromOrderIndexes":[3],"interventions":{"note":["Continue to progress range of motion, strength, proprioception"]},"achillesInterventions":{},"restOfBodyInterventions":{"note":["Continue to progress range of motion, strength, proprioception"]},"gaitTraining":null},{"orderIndex":5,"number":null,"name":null,"timeframeLabel":">12 weeks","timeframeStartDays":84,"timeframeEndDays":null,"weightBearing":{"label":"Full weight-bearing.","inferred":true,"note":"Not stated verbatim in the source table for this row — inferred because crutches/cane are already being weaned off by the prior 8-12 week row. Distinct from the 4-6 and 6-8 week rows' 'weight-bearing as tolerated,' which is a different, partial-load term and should not be conflated with full weight-bearing."},"assistiveDevices":[],"interventions":{"progression":["Continue to progress ROM, strength, proprioception","Retrain strength, power, endurance","Increase dynamic weight-bearing exercise, include plyometric training","Sport-specific retraining"]},"achillesInterventions":{},"restOfBodyInterventions":{"progression":["Continue to progress ROM, strength, proprioception","Retrain strength, power, endurance","Increase dynamic weight-bearing exercise, include plyometric training","Sport-specific retraining"]},"gaitTraining":null}]}$jsonb$::jsonb,
  true,
  null
);
...
values (
  ...
  $jsonb${"romMobility":["Active plantar flexion and dorsiflexion to neutral","Inversion/eversion below neutral"],"modalities":["Modalities to control swelling","Incision mobilization modalities"]}$jsonb$::jsonb,
  $jsonb${"strengthening":["Knee/hip exercises with no ankle involvement (leg lifts from sitting, prone, or side-lying)"],"cardio":["Non-weight-bearing fitness/cardio: one-leg bicycling, deep-water running"],"other":["Hydrotherapy within motion and weight-bearing limits"]}$jsonb$::jsonb,
  $jsonb$null$jsonb$::jsonb,
  $jsonb$null$jsonb$::jsonb,
  $jsonb$null$jsonb$::jsonb,
  null,
...
values (
  ...
  $jsonb${"romMobility":["Dorsiflexion stretching, slowly"],"modalities":["Ice, heat, ultrasound as indicated","Incision mobilization"]}$jsonb$::jsonb,
  $jsonb${"strengthening":["Graduated resistance exercises (open and closed kinetic chain, plus functional activities)"],"cardio":["Fitness/cardio including WBAT: bicycling, elliptical, treadmill walking/running, StairMaster"],"other":["Hydrotherapy"]}$jsonb$::jsonb,
  $jsonb$["Proprioceptive and gait retraining"]$jsonb$::jsonb,
  $jsonb$null$jsonb$::jsonb,
  $jsonb$null$jsonb$::jsonb,
  null,
  $jsonb$[]$jsonb$::jsonb
